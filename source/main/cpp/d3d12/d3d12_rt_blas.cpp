    ...
    namespace ngfx
    {
        ...
        namespace nd3d12
        {
            ...
            bool Create(ngfx::device_t* pDevice, ngfx::blas_t* pBLAS)
            {
                ...
                for (size_t i = 0; i < pBLAS->m_desc.geometries.size; ++i)
                {
                ...
                buildInput.pGeometryDescs = dxblas->m_geometries.data;
                ...
                pAllocator->CreateResource(&allocationDesc, &scratchBufferDesc, D3D12_RESOURCE_STATE_COMMON, nullptr, &dxblas->m_pScratchAllocation, IID_PPV_ARGS(&m_pScratchBuffer));
            ...
            void GetUpdateDesc(nd3d12::blas_t* dxblas, ngfx::blas_t* blas, D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_DESC& desc, D3D12_RAYTRACING_GEOMETRY_DESC& geometry, buffer_t* vertex_buffer, u32 vertex_buffer_offset)
            {
                ...
                geometry                                     = dxblas->m_geometries.data[0];
