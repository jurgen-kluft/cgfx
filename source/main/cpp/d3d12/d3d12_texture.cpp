...
namespace ncore
{
    namespace ngfx
    {
        ...
        D3D12Texture::D3D12Texture(D3D12Device* pDevice, const texture_desc_t& desc, const char* name)
        {
            m_pDevice = pDevice;
            m_desc    = desc;
            m_name    = name;
        ...
        bool D3D12Texture::Create()
        {
            ...
            else
            {
                ...
                hr = pAllocator->CreateResource3(&allocationDesc, &resourceDesc1, initial_layout, nullptr, 0, nullptr, &m_pAllocation, IID_PPV_ARGS(&m_pTexture));
            }
        ...
        D3D12_CPU_DESCRIPTOR_HANDLE D3D12Texture::GetRTV(u32 mip_slice, u32 array_slice)
        {
        ...
        D3D12_CPU_DESCRIPTOR_HANDLE D3D12Texture::GetDSV(u32 mip_slice, u32 array_slice)
        {
        ...
        D3D12_CPU_DESCRIPTOR_HANDLE D3D12Texture::GetReadOnlyDSV(u32 mip_slice, u32 array_slice)
        {
            ASSERT(m_desc.usage & GfxTextureUsageDepthStencil);
        ...
        u32 D3D12Texture::GetRequiredStagingBufferSize() const
        {
            ID3D12Device* pDevice = (ID3D12Device*)m_pDevice->GetHandle();

            D3D12_RESOURCE_DESC desc              = m_pTexture->GetDesc();
            u32                 subresource_count = m_desc.mip_levels * m_desc.array_size;
        ...
        u32 D3D12Texture::GetRowPitch(u32 mip_level) const
        {
            ASSERT(mip_level < m_desc.mip_levels);
